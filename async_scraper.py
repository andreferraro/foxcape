...
class AsyncStealthScraper:
    ...
    async def __aenter__(self) -> "AsyncStealthScraper":
        await self.start()
        return self
    ...
    async def get_page(self) -> Any:
        ...
        if self._page is None:
            raise RuntimeError("Failed to initialize async page context.")
        return self._page
    ...
    async def get(
        ...
        if self._page is None:
            raise RuntimeError("Failed to acquire async page context.")

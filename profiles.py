...
logger = logging.getLogger("stealth_scraper.profiles")
...
class BrowserProfile:
    ...
    def to_scraper_config(self, base_config: ScraperConfig | None = None) -> ScraperConfig:
        """Converts profile into a persistent ScraperConfig instance with stale lock cleanup."""
        self.clean_lock()
        cfg = base_config or ScraperConfig()
    ...
    def warmup(
        ...
        with StealthScraper(config) as scraper:
